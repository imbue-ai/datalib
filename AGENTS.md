...
- [`docs/dev/plans/supervisor.md`](docs/dev/plans/supervisor.md) — greenfield alternative to the join: one resident supervisor reconciles graph, intent and facts; sinks first-class with one writer at a time; per-row Sync/Stop/Pause for people and agents alike.
