...
- [`docs/dev/plans/completed/logs_and_metrics.md`](docs/dev/plans/completed/logs_and_metrics.md) — built: the run store `system/runs/runs.sqlite`, also the app server's log.
