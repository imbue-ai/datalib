...
use datalib_etl_whatsapp_config::WhatsappConfig;
use datalib_etl_yolink_config::YolinkConfig;
...
/// Settings for the retired `datalib-sync` legacy config format — the
