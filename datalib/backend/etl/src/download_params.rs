...
//!
//! The type itself now lives in the schema-only `datalib_source_common`
...
//! `datalib_etl::download_params::DownloadParams` call sites keep resolving.

pub use datalib_source_common::download_params::DownloadParams;
