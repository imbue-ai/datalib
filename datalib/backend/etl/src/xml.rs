//! The one quick-xml idiom every XML-reading provider shares: since
//! quick-xml 0.38 an entity or character reference (`&amp;`, `&#8217;`)
//! arrives as its own `Event::GeneralRef` between text events, and the
//! parser appends what it stands for to the text it sits in.
