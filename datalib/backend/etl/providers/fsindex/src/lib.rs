...
//! [`download::schema_raw`] for the cursor table that backs it), and
...
//! primitive.
//!
//! This crate is the **download side only** for now; the schema
//! lives at [`download::schema_raw`] and the rest of the walker /
//! stamp-compare / hasher / db / options modules will land in
//! follow-up commits. Render is deliberately out of scope until
