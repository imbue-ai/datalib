...
//!
//! See `docs/dev/archived/google_takeout_ingestion.md` for the design.
//!
...
//! (`datalib_etl::bulk` + `datalib_etl::blob_cas`) — the
...
//!   `docs/dev/archived/google_takeout_ingestion.md` § "Out of scope (first
//!   pass)".
