...
`github-ingest` mirrors GitHub pull requests + their conversation via
...
`github-ingest` runs each `--scope` (default: `author:@me`,
...
export LATCHKEY_CURL=$PWD/bazel-bin/third-party/latchkey-curl-shims/latchkey-curl-router   # for parity with other providers
