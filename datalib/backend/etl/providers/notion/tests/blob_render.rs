...
use datalib_etl_notion::render::parse::ParsedNotionOfficial;
use datalib_etl_notion::render::render::render_notion_official;
...
fn incremental_renders_only_changed_page() {
    ...
    let summary1 = render_notion_official(
        ...
        &datalib_etl::progress::Progress::noop(),
        &std::collections::HashMap::new(),
        &mut |doc: datalib_etl::grid_index::RenderedMarkdown| -> anyhow::Result<()> {
