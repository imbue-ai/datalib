...
//!
//! Single sqlite file at `<data_root>/raw/<name>/entities.doltlite_db`. Shared
...
impl RawDb {
    ...
    pub async fn row_counts(&self) -> Result<RowCounts> {
        ...
        // up through the extract `FetchSummary` directly.
        let blob_errors = 0;
        Ok(RowCounts {
            rooms,
            users,
    ...
    /// [`crate::render_and_index_md::beeper_room_uuid`].
