...
/// Translate entry point. Same signature as before the contact-common
/// migration so the sync runner's translate match-arm is unchanged.
///
...
mod tests {
    use super::*;
    use crate::extract::api::VcardProp;
