// Quick-add source templates for the Sources table. Each body is one
// *fragment* in the `configSplit` sense: a top-level YAML mapping
// (`name:` / `source:`), i.e. a `sources:` list item without its `- `
// marker. The orchestrator owns only `name`/`enabled`; everything
// provider-owned (including `type:`) nests under `source:` — see
