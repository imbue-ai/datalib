...
| Run store `system/runs/runs.sqlite` | `app_schema::runs` | `PRAGMA user_version` against `datalib_runs::SCHEMA_VERSION` (7; it has moved in six commits since 2026-09-11) | **delete the file and remake it** | `user_version` |
