...
```sh
doltlite -readonly raw/slack.doltlite_db \
...
```sh
doltlite -readonly raw/slack.doltlite_db "SELECT active_branch();"
doltlite -readonly raw/slack.doltlite_db "SELECT * FROM dolt_branches;"
```
...
```sh
doltlite -readonly -box raw/slack.doltlite_db "SELECT * FROM dolt_log() LIMIT 5;"
```
